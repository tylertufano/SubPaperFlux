...
TEMPLATE_DEFINITIONS: List[TemplateDefinition] = [
    TemplateDefinition(
        ...
        description="Example SubPaperFlux worker configuration file.",
        categories=["configuration"],
    ),
    TemplateDefinition(
        id="credentials-store",
        filename="credentials.example.json",
        title="Credentials store",
        description="Template for storing encrypted credentials metadata.",
        categories=["credentials", "configuration"],
    ),
    TemplateDefinition(
        id="site-configs",
        filename="site_configs.example.json",
        title="Site configurations",
        description="Sample site configuration collection for ingestion targets.",
        categories=["configuration"],
    ),
    TemplateDefinition(
        id="instapaper-app",
        filename="instapaper_app_creds.example.json",
        title="Instapaper app credentials",
        description="OAuth client template for Instapaper integrations.",
        categories=["credentials", "integrations"],
    ),
    TemplateDefinition(
