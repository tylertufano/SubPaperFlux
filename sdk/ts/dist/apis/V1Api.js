...
class V1Api extends runtime.BaseAPI {
    ...
    createCredentialV1V1CredentialsPostRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const response = yield this.request({
                ...
                headers: headerParameters,
                query: queryParameters,
                body: (0, models_1.CredentialToJSON)(requestParameters.credential),
            }, initOverrides);
            return new runtime.JSONApiResponse(response, (jsonValue) => (0, models_1.CredentialFromJSON)(jsonValue));
        });
    }
    ...
    createFeedV1V1FeedsPostRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return new runtime.JSONApiResponse(response, (jsonValue) => (0, models_1.FeedOutFromJSON)(jsonValue));
        });
    }
    /**
     * Create feed
    ...
    createInstapaperCredentialFromLoginV1V1CredentialsInstapaperLoginPostRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const response = yield this.request({
                ...
                headers: headerParameters,
                query: queryParameters,
                body: (0, models_1.InstapaperLoginRequestToJSON)(requestParameters.instapaperLoginRequest),
            }, initOverrides);
            return new runtime.JSONApiResponse(response, (jsonValue) => (0, models_1.CredentialFromJSON)(jsonValue));
        });
    }
