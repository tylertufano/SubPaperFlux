...
exports.SiteConfigApiOutToJSON = exports.SiteConfigApiOutFromJSONTyped = exports.SiteConfigApiOutFromJSON = exports.instanceOfSiteConfigApiOut = void 0;
const runtime_1 = require("../runtime");
const ApiConfig_1 = require("./ApiConfig");
/**
 * Check if a given object implements the SiteConfigApiOut interface.
 */
function instanceOfSiteConfigApiOut(value) {
    let isInstance = true;
...
exports.instanceOfSiteConfigApiOut = instanceOfSiteConfigApiOut;
function SiteConfigApiOutFromJSON(json) {
    return SiteConfigApiOutFromJSONTyped(json, false);
}
exports.SiteConfigApiOutFromJSON = SiteConfigApiOutFromJSON;
function SiteConfigApiOutFromJSONTyped(json, ignoreDiscriminator) {
...
exports.SiteConfigApiOutFromJSONTyped = SiteConfigApiOutFromJSONTyped;
function SiteConfigApiOutToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
...
exports.SiteConfigApiOutToJSON = SiteConfigApiOutToJSON;
