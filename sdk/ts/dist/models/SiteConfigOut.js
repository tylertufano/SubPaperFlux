...
exports.SiteConfigOutToJSONTyped = exports.SiteConfigOutToJSON = exports.SiteConfigOutFromJSONTyped = exports.SiteConfigOutFromJSON = exports.instanceOfSiteConfigOut = void 0;
/**
 * Check if a given object implements the SiteConfigOut interface.
 */
function instanceOfSiteConfigOut(value) {
...
exports.instanceOfSiteConfigOut = instanceOfSiteConfigOut;
function SiteConfigOutFromJSON(json) {
    return SiteConfigOutFromJSONTyped(json, false);
}
exports.SiteConfigOutFromJSON = SiteConfigOutFromJSON;
function SiteConfigOutFromJSONTyped(json, ignoreDiscriminator) {
    if (json == null) {
        return json;
    }
    return {
...
exports.SiteConfigOutFromJSONTyped = SiteConfigOutFromJSONTyped;
function SiteConfigOutToJSON(json) {
    return SiteConfigOutToJSONTyped(json, false);
}
exports.SiteConfigOutToJSON = SiteConfigOutToJSON;
function SiteConfigOutToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
...
exports.SiteConfigOutToJSONTyped = SiteConfigOutToJSONTyped;
