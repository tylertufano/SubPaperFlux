 ...
 */
export function instanceOfSiteConfig(value) {
...
export function SiteConfigFromJSON(json) {
    return SiteConfigFromJSONTyped(json, false);
}
export function SiteConfigFromJSONTyped(json, ignoreDiscriminator) {
    if (json == null) {
        return json;
    }
    return {
...
export function SiteConfigToJSON(json) {
    return SiteConfigToJSONTyped(json, false);
}
export function SiteConfigToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
