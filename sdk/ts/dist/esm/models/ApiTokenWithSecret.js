 ...
 */
export function instanceOfApiTokenWithSecret(value) {
...
export function ApiTokenWithSecretFromJSON(json) {
    return ApiTokenWithSecretFromJSONTyped(json, false);
}
export function ApiTokenWithSecretFromJSONTyped(json, ignoreDiscriminator) {
    if (json == null) {
        return json;
    }
    return {
...
export function ApiTokenWithSecretToJSON(json) {
    return ApiTokenWithSecretToJSONTyped(json, false);
}
export function ApiTokenWithSecretToJSONTyped(value, ignoreDiscriminator = false) {
    var _a, _b, _c;
    if (value == null) {
        return value;
    }
