 ...
 */
export function instanceOfSiteConfigOut(value) {
...
export function SiteConfigOutFromJSON(json) {
    return SiteConfigOutFromJSONTyped(json, false);
}
export function SiteConfigOutFromJSONTyped(json, ignoreDiscriminator) {
    if (json == null) {
        return json;
    }
    return {
...
export function SiteConfigOutToJSON(json) {
    return SiteConfigOutToJSONTyped(json, false);
}
export function SiteConfigOutToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
